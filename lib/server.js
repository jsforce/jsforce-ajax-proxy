...
app.get('/kbsearch/', cors(corsOptions), async function (req, res) {
    ...
    var raw = JSON.stringify(qrySet(qryParams.currCat, qryParams.srhTxt, categories, tags));
    var requestOptions = {
        method: 'POST',
        headers: {
			"Authorization": "Bearer " + qryParams.token,
...
app.post('/uploadfile/', function (req, res) {
	...
	// conn = new jsforce.Connection({
	// 	instanceUrl : "https://force-ability-3133-dev-ed.cs189.my.salesforce.com",
	// 	accessToken : "00D7a0000005H48!AQUAQFQxrC6dERhhPmMWGwItS4RXhOUwvzAJJGevrVfzWYN7TOLkdXese.VtO8j8v9yQxsU9AS7h0K2uYctGx9cDWsEiTSyB"
	// });
	result = conn.sobject('ContentVersion').create({
		PathOnClient : fileName,
		VersionData : fileContent.contentData,
		avnio__IsActive__c: true,
		avnio__IsTemplate__c: true,
	});
	return res.send(result);
});
